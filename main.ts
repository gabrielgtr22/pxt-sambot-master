//% weight=0 color=#F0475A  icon="\uf207" block="sambot"
namespace Sambot {
    ...
    /**
    * TODO: initialization sambot
    * @param left describe parameter here, eg: AnalogPin.P1
    * @param right describe parameter here, eg: AnalogPin.P2
    */
    //% weight=99
    //% blockId=sambot_init block="set left wheel at pin %left|right wheel at pin %right"
    ...
    */
    //% weight=9
    //% blockId=sambot_forward block="go straight at full speed"
    ...
    */
    //% weight=8
    //% blockId=sambot_back block="reverse at full speed"
    ...
    */
    //% weight=7
    //% blockId=sambot_left block="turn left at full speed"
    ...
    */
    //% weight=6
    //% blockId=sambot_right block="turn right at full speed"
    ...
    */
    //% weight=5
    //% blockId=sambot_brake block="brake"
    ...
    */
    //% weight=4
    //% blockId=sambot_freestyle block="set left wheel speed at %m| right wheel speed at %n"
    //% m.min=-100 m.max=100
    //% n.min=-100 n.max=100
    ...
    */
    //% weight=10
    //% advanced=true
    //% blockId=sambot_tracking block="tracking state is %state"
    ...
    */
    //% weight=9
    //% advanced=true
    //% blockId=sambot_sonarbit block="ultrasonic distance in unit %distance_unit"
    export function sambot_sonarbit(distance_unit: Distance_Unit): number {
